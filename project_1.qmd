...
This report examines pre-VR conditions and side effect severity after VR exposure. Analyses include a scatter plot showing a positive relation between VR anxiety and severity, double box plot comparing state anxiety with severity, and a comparative box plot linking expectancy to severity. Findings suggest anxiety positively affects side effects.
:::
...
::: {style="text-align: justify;"}
We assumed the variables (PSTAI, p_e, and p_vra) accurately measure anxiety and that participants understood and completed the surveys correctly.
:::
...
::: {style="text-align: justify;"}
The correlation between VR anxiety and side effect severity shows $0.388$, indicating a moderate positive correlation. Figure 1 supports a linear relationship between two variables. Figure 2 reinforces the relationship by showing approximately random and the same variances (homoscedasticity) in the vertical direction along the fitted axis (Although the spread of residuals looks uneven). In conclusion, a linear model between these two variables is appropriate.
...
::: {style="text-align: justify;"}
The above comparative double box plot shows that side effect severity aligned with anxiety, as indicated by higher reports of tension and worry and lower reports of relaxation and calmness, consistent with established markers of anxiety (American Psychiatric Association, 2022).
...
|                           |               | -   Yuexi Luo           |
+---------------------------+---------------+-------------------------+
| Friday, 19 September 2025 | 18:00 - 20:30 | -   Kenneth Davis       |
|                           |               |                         |
|                           |               | -   Rickey Arvidson     |
|                           |               |                         |
|                           |               | -   Leo Trimble         |
...
|----|----|
| Kenneth Davis | Analysis (VR Anxiety and Side Effect Severity Relationship) and Format Beautification |
...
-   OpenAI. (2025, September 19). *Response to question about hiding legends and hover info in ggplotly boxplots* \[ChatGPT response, GPT-5 mini\]. <https://openai.com/chatgpt>

-   OpenAI. (2025, September 16). Response to request for concise methods in executive summary writing \[ChatGPT response, GPT-5 mini\]. <https://openai.com/chatgpt>

-   OpenAI. (2025, September 15). Response to request for code refinement and re-layout in figure *Side Effect Severity by Expectancy Group* \[ChatGPT response, GPT-5 mini\]. <https://openai.com/chatgpt>

-   OpenAI. (2025, September 18). Response to request for text refinement in section *Distribution of Side Effect Severity Scores by PSTAI Group* \[ChatGPT response, GPT-5 mini\]. <https://openai.com/chatgpt>

-   OpenAI. (2025, September 18). Response to request for methodology suggestion in data transformation \[ChatGPT response, GPT-5 mini\]. <https://openai.com/chatgpt>

-   *Center Plot title in ggplot2*. (n.d.). Stack Overflow. <https://stackoverflow.com/questions/40675778/center-plot-title-in-ggplot2>
...
-   Centers for Disease Control and Prevention. (2024, June 25). *Symptoms of COVID-19*. COVID-19; CDC. [https://www.cdc.gov/covid/signs-symptoms/index.html](https://www.cdc.gov/covid/signs-symptoms/index.html))
...
AI used to find a way to hide legends and hover info for figure "Side Effect Severity by Expectancy Group".
